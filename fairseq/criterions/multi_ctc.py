...
@dataclass
class MultiCtcCriterionConfig(FairseqDataclass):
    ...
    ## 추가
    multi_use_update: int = field(
        default=0,
        metadata={"help": "dont finetune wav2vec for this many updates"},
    )


@register_criterion("multi_ctc", dataclass=MultiCtcCriterionConfig)
class MultiCtcCriterion(FairseqCriterion):
    def __init__(self, cfg: MultiCtcCriterionConfig, task: FairseqTask):
        super().__init__(task)
