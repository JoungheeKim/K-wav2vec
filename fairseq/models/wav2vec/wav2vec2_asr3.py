...
@dataclass
class Wav2Vec2Ctc3Config(Wav2Vec2AsrConfig):
...
@register_model("wav2vec_ctc3", dataclass=Wav2Vec2Ctc3Config)
class Wav2VecCtc3(BaseFairseqModel):
    def __init__(self, cfg: Wav2Vec2Ctc3Config, w2v_encoder: BaseFairseqModel):
        super().__init__()
        self.cfg = cfg
...
class Wav2VecEncoder3(FairseqEncoder):
